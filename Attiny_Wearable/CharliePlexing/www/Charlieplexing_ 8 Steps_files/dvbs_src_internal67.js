...
0,{}));c.hasOwnProperty("err")&&(b=c.err);return{vdcv:26,vdcd:c.res,err:b}}catch(e){return{vdcv:26,vdcd:"0",err:b}}}function R(b){for(var c=0;10>c&&b!=window._dv_win.top;)c++,b=b.parent;return c}function S(b){try{if(1>=b.depth)return{url:"",depth:""};var c=[];c.push({win:window._dv_win.top,depth:0});for(var e,f=1,d=0;0<f&&100>d;){try{if(d++,e=c.shift(),f--,0<e.win.location.toString().length&&e.win!=b)return 0==e.win.document.referrer.length||0==e.depth?{url:e.win.location,depth:e.depth}:{url:e.win.document.referrer,
depth:e.depth-1}}catch(l){}var h=e.win.frames.length;for(var k=0;k<h;k++)c.push({win:e.win.frames[k],depth:e.depth+1}),f++}return{url:"",depth:""}}catch(l){return{url:"",depth:""}}}function W(){var b=window._dv_win[F("=@42E:@?")][F("2?46DE@C~C:8:?D")];if(b&&0<b.length){var c=[];c[0]=window._dv_win.location.protocol+"//"+window._dv_win.location.hostname;for(var e=0;e<b.length;e++)c[e+1]=b[e];return c.reverse().join(",")}return null}function F(b){new String;var c=new String,e;for(e=0;e<b.length;e++){var f=
b.charAt(e);var d="!\"#$%&'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~".indexOf(f);0<=d&&(f="!\"#$%&'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~".charAt((d+47)%94));c+=f}return c}function A(){return Math.floor(1E12*(Math.random()+""))}function T(b){for(var c=[{id:4,brRegex:"OPR|Opera",verRegex:"(OPR/|Version/)"},{id:1,brRegex:"MSIE|Trident/7.*rv:11|rv:11.*Trident/7|Edge/",verRegex:"(MSIE |rv:| Edge/)"},{id:2,
...
document.createElement(arguments[0]):f?document.createElementNS.call(document,"http://www.w3.org/2000/svg",arguments[0]):document.createElement.apply(document,arguments)},h=["Moz","O","ms","Webkit"],k=["moz","o","ms","webkit"],l={style:d("modernizr").style},m=function(b,c){function e(){g&&(delete l.style,delete l.modElem)}var f;for(f=["modernizr","tspan","samp"];!l.style&&f.length;){var g=!0;l.modElem=d(f.shift());l.style=l.modElem.style}var h=b.length;for(f=0;f<h;f++){var k=b[f];~(""+k).indexOf("-")&&
(k=cssToDOM(k));if(void 0!==l.style[k])return e(),"pfx"==c?k:!0}e();return!1},u=function(b,c,d){var f=b.charAt(0).toUpperCase()+b.slice(1),g=(b+" "+h.join(f+" ")+f).split(" ");if("string"===typeof c||"undefined"===typeof c)return m(g,c);g=(b+" "+k.join(f+" ")+f).split(" ");for(var l in g)if(g[l]in c){if(!1===d)return g[l];b=c[g[l]];return"function"===typeof b?e(b,d||c):b}return!1};c(0,!0);c(1,u("requestFileSystem",window));c(2,window.CSS?"function"==typeof window.CSS.escape:!1);c(3,u("shapeOutside",
"content-box",!0));return b}catch(g){return 0}}function K(){var b=window,c=0;try{for(;b.parent&&b!=b.parent&&b.parent.document&&!(b=b.parent,10<c++););}catch(e){}return b}function Y(){try{var b=K(),c=0,e=0,f=function(b,d,f){f&&(c+=Math.pow(2,b),e+=Math.pow(2,d))},d=b.document;f(14,0,b.playerInstance&&d.querySelector('script[src*="ads-player.com"]'));f(14,1,(b.CustomWLAdServer||b.DbcbdConfig)&&(a=d.querySelector('p[class="footerCopyright"]'),a&&a.textContent.match(/ MangaLife 2016/)));f(15,2,b.zpz&&
b.zpz.createPlayer);f(15,3,b.vdApp&&b.vdApp.createPlayer);f(15,4,d.querySelector('body>div[class="z-z-z"]'));f(16,5,b.xy_checksum&&b.place_player&&(b.logjwonready&&b.logContentPauseRequested||b.jwplayer));f(17,6,b==b.top&&""==d.title?(a=d.querySelector('body>object[id="player"]'),a&&a.data&&1<a.data.indexOf("jwplayer")&&"visibility: visible;"==a.getAttribute("style")):!1);f(17,7,d.querySelector('script[src*="sitewebvideo.com"]'));f(17,8,b.InitPage&&b.cef&&b.InitAd);f(17,9,b==b.top&&""==d.title?(a=
...
b.document.styleSheets,d=0;d<c.length;d++)for(var f=b.document.styleSheets[d].cssRules,e=0;e<f.length;e++)if("div.kk"==f[e].selectorText||"div.asu"==f[e].selectorText)return!0}catch(n){}}());a:{try{var h=null!=d.querySelector('div[id="kt_player"][hiegth]');break a}catch(m){}h=void 0}f(21,14,h);a:{try{var k=b.top==b&&null!=b.document.querySelector('div[id="asu"][class="kk"]');break a}catch(m){}k=void 0}f(22,15,k);a:{try{var l=d.querySelector('object[data*="/VPAIDFlash.swf"]')&&d.querySelector('object[id*="vpaid_video_flash_tester_el"]')&&
d.querySelector('div[id*="desktopSubModal"]');break a}catch(m){}l=void 0}f(25,16,l);return{f:c,s:e}}catch(m){return null}}function Z(){try{var b="&fcifrms="+window.top.length;window.history&&(b+="&brh="+window.history.length);var c=K(),e=c.document;if(c==window.top){b+="&fwc="+((c.FB?1:0)+(c.twttr?2:0)+(c.outbrain?4:0)+(c._taboola?8:0));try{e.cookie&&(b+="&fcl="+e.cookie.length)}catch(f){}c.performance&&c.performance.timing&&0<c.performance.timing.domainLookupStart&&0<c.performance.timing.domainLookupEnd&&
(b+="&flt="+(c.performance.timing.domainLookupEnd-c.performance.timing.domainLookupStart));e.querySelectorAll&&(b+="&fec="+e.querySelectorAll("*").length)}return b}catch(f){return""}}function V(){function b(b){if(null==b||""==b)return"";var c=function(b,c){return b<<c|b>>>32-c},d=function(b){for(var c="",d,e=7;0<=e;e--)d=b>>>4*e&15,c+=d.toString(16);return c},f=[1518500249,1859775393,2400959708,3395469782];b+=String.fromCharCode(128);for(var e=Math.ceil((b.length/4+2)/16),g=Array(e),h=0;h<e;h++){g[h]=
Array(16);for(var n=0;16>n;n++)g[h][n]=b.charCodeAt(64*h+4*n)<<24|b.charCodeAt(64*h+4*n+1)<<16|b.charCodeAt(64*h+4*n+2)<<8|b.charCodeAt(64*h+4*n+3)}g[e-1][14]=8*(b.length-1)/Math.pow(2,32);g[e-1][14]=Math.floor(g[e-1][14]);g[e-1][15]=8*(b.length-1)&4294967295;b=1732584193;n=4023233417;var p=2562383102,q=271733878,v=3285377520,r=Array(80);for(h=0;h<e;h++){for(var t=0;16>t;t++)r[t]=g[h][t];for(t=16;80>t;t++)r[t]=c(r[t-3]^r[t-8]^r[t-14]^r[t-16],1);var D=b;var y=n;var x=p;var z=q;var A=v;for(t=0;80>t;t++){var E=
Math.floor(t/20),B=c(D,5);a:{switch(E){case 0:var C=y&x^~y&z;break a;case 1:C=y^x^z;break a;case 2:C=y&x^y&z^x&z;break a;case 3:C=y^x^z;break a}C=void 0}E=B+C+A+f[E]+r[t]&4294967295;A=z;z=x;x=c(y,30);y=D;D=E}b=b+D&4294967295;n=n+y&4294967295;p=p+x&4294967295;q=q+z&4294967295;v=v+A&4294967295}return d(b)+d(n)+d(p)+d(q)+d(v)}function c(){try{return!!window.sessionStorage}catch(h){return!0}}function e(){try{return!!window.localStorage}catch(h){return!0}}function f(){try{var b=document.createElement("canvas");
if(b.getContext&&b.getContext("2d")){var c=b.getContext("2d");c.textBaseline="top";c.font="14px 'Arial'";c.textBaseline="alphabetic";c.fillStyle="#f60";c.fillRect(0,0,62,20);c.fillStyle="#069";c.fillText("!image!",2,15);c.fillStyle="rgba(102, 204, 0, 0.7)";c.fillText("!image!",4,17);return b.toDataURL()}}catch(l){}return null}try{var d=[];d.push(["lang",navigator.language||navigator.browserLanguage]);d.push(["tz",(new Date).getTimezoneOffset()]);d.push(["hss",c()?"1":"0"]);d.push(["hls",e()?"1":"0"]);
d.push(["odb",typeof window.openDatabase||""]);d.push(["cpu",navigator.cpuClass||""]);d.push(["pf",navigator.platform||""]);d.push(["dnt",navigator.doNotTrack||""]);d.push(["canv",f()]);return b(d.join("=!!!="))}catch(h){return null}}this.createRequest=function(){var b=!1,c=window._dv_win,e=0,f=!1,d;try{for(d=0;10>=d;d++)if(null!=c.parent&&c.parent!=c)if(0<c.parent.location.toString().length)c=c.parent,e++,b=!0;else{b=!1;break}else{0==d&&(b=!0);break}}catch(v){b=!1}a:{try{var h=c.$sf;break a}catch(v){}h=
void 0}if(0==c.document.referrer.length)b=c.location;else if(b)b=c.location;else{b=c.document.referrer;if(G(b)){a:{try{var k=c.$sf&&c.$sf.ext&&c.$sf.ext.hostURL&&c.$sf.ext.hostURL();break a}catch(v){}k=void 0}if(k&&!G(k)&&0==k.indexOf(b)){b=k;var l=!0}}f=!0}if(!window._dv_win.dvbsScriptsInternal||!window._dv_win.dvbsProcessed||0==window._dv_win.dvbsScriptsInternal.length)return{isSev1:!1,url:null};d=window._dv_win.dv_config&&window._dv_win.dv_config.isUT?window._dv_win.dvbsScriptsInternal[window._dv_win.dvbsScriptsInternal.length-
1]:window._dv_win.dvbsScriptsInternal.pop();k=d.script;this.dv_script_obj=d;this.dv_script=k;window._dv_win.dvbsProcessed.push(d);window._dv_win._dvScripts.push(k);var m=k.src;this.dvOther=0;this.dvStep=1;var u=window._dv_win.dv_config?window._dv_win.dv_config.bst2tid?window._dv_win.dv_config.bst2tid:window._dv_win.dv_config.dv_GetRnd?window._dv_win.dv_config.dv_GetRnd():A():A();d=window.parent.postMessage&&window.JSON;var g=!0,w=!1;if("0"==dv_GetParam(m,"t2te")||window._dv_win.dv_config&&1==window._dv_win.dv_config.supressT2T)w=
!0;if(d&&0==w)try{var n=H(window._dv_win.dv_config.bst2turl||"https://cdn3.doubleverify.com/bst2tv3.html","bst2t_"+u);g=B(n)}catch(v){}n={};try{w=/[\?&]([^&]*)=([^&#]*)/gi;for(var p=w.exec(m);null!=p;)"eparams"!==p[1]&&(n[p[1]]=p[2]),p=w.exec(m);var q=n}catch(v){q=n}q.perf=this.perf;q.uid=u;q.script=this.dv_script;q.callbackName="__verify_callback_"+q.uid;q.tagObjectCallbackName="__tagObject_callback_"+q.uid;q.tagAdtag=null;q.tagPassback=null;q.tagIntegrityFlag="";q.tagHasPassbackFlag="";0==(null!=
q.tagformat&&"2"==q.tagformat)&&(p=Q(q.script),q.tagAdtag=p.tagAdTag,q.tagPassback=p.tagPassback,p.isBadImp?q.tagIntegrityFlag="&isbadimp=1":p.hasPassback&&(q.tagHasPassbackFlag="&tagpb=1"));(p=(/iPhone|iPad|iPod|\(Apple TV|iOS|Coremedia|CFNetwork\/.*Darwin/i.test(navigator.userAgent)||navigator.vendor&&"apple, inc."===navigator.vendor.toLowerCase())&&!window.MSStream)?n="https:":(n=q.script.src,m="http:",u=window._dv_win.location.toString().match("^http(?:s)?"),"https"!=n.match("^https")||"https"!=
u&&"http"==u||(m="https:"),n=m);q.protocol=n;q.ssl="0";"https:"===q.protocol&&(q.ssl="1");n=q;(m=window._dv_win.dvRecoveryObj)?("2"!=n.tagformat&&(m=m[n.ctx]?m[n.ctx].RecoveryTagID:m._fallback_?m._fallback_.RecoveryTagID:1,1===m&&n.tagAdtag?document.write(n.tagAdtag):2===m&&n.tagPassback&&document.write(n.tagPassback)),n=!0):n=!1;if(n)return{isSev1:!0};this.dvStep=2;P(q,p);k=k&&k.parentElement&&k.parentElement.tagName&&"HEAD"===k.parentElement.tagName;this.dvStep=3;return J(this,q,b,c,e,f,d,g,k,p,
l,h)};this.sendRequest=function(b){var c=dv_GetParam(b,"tagformat");c&&"2"==c?$dvbs.domUtilities.addScriptResource(b,document.body):dv_sendScriptRequest(b);try{if("1"!=dv_GetParam(b,"foie")){var e=N(this.dv_script_obj&&this.dv_script_obj.injScripts),f=H("about:blank");f.id=f.name;var d=f.id.replace("iframe_","");f.setAttribute&&f.setAttribute("data-dv-frm",d);B(f,this.dv_script);if(this.dv_script){var h=this.dv_script;a:{b=null;try{if(b=f.contentWindow){var k=b;break a}}catch(g){}try{if(b=window._dv_win.frames&&
window._dv_win.frames[f.name]){k=b;break a}}catch(g){}k=null}h.dvFrmWin=k}a:{var l;if(f&&(l=f.contentDocument||f.contentWindow&&f.contentWindow.document)){var m=l;break a}m=(l=window._dv_win.frames&&window._dv_win.frames[f.name]&&window._dv_win.frames[f.name].document)?l:null}if(m)m.open(),m.write(e);else{try{document.domain=document.domain}catch(g){}var u=encodeURIComponent(e.replace(/'/g,"\\'").replace(/\n|\r\n|\r/g,""));f.src='javascript: (function(){document.open();document.domain="'+window.document.domain+
"\";document.write('"+u+"');})()"}}}catch(g){e=(window._dv_win.dv_config=window._dv_win.dv_config||{}).tpsAddress||"rtb0.doubleverify.com",f=[this.getVersionParamName(),this.getVersion()].join("="),e+=["/verify.js?ctx=818052&cmp=1619415&num=6",f].join("&"),dv_SendErrorImp(e,[{dvp_jsErrMsg:"DvFrame: "+encodeURIComponent(g)}])}return!0};this.isApplicable=function(){return!0};this.onFailure=function(){};window.debugScript&&(window.CreateUrl=J);this.getVersionParamName=function(){return"ver"};this.getVersion=
function(){return"117"}};
